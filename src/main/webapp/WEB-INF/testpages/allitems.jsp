...
<main>
    ...
    <div class="maindivstyle">
        <form method="post" action="/allitems">
            <div style="margin-left: 20px">
                <table border="1" class="tablemain">
                    ...
                    <tr class="titlerow">
                        ...
                        <td align="middle">Buy checkbox</td>
                        <td align="middle"><input type="submit" value="Buy"/></td>
                    </tr>
                    <c:forEach items="${allitems}" var="items">
                        <tr class="restrows">
                            ...
                            <td align="middle"><input type="checkbox" name="checkbox_id" value="${items.id}"></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
