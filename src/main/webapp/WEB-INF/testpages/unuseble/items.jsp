        ...
        <div style="margin-left: 20px" >
            <table border="1" class="tablemain" >
                ...
                <tr class="titlerow">
                    ...
                    <td  align="middle">Buyer</td>
                    <td  align="middle">Seller</td>
                    <td  align="middle">Is sold</td>
                </tr>
                <c:forEach items="${items}" var="item">
                    <tr class="restrows">
                        <td align="middle"><c:out value="${item.id}"/></td>
                        <td align="middle"><c:out value="${item.name}"/></td>
                        <td align="middle"><c:out value="${item.description}"/></td>
                        <td align="middle"><c:out value="${item.price}"/></td>
                        <td align="middle"><c:out value="${item.buyer}"/></td>
                        <td align="middle"><c:out value="${item.seller}"/></td>
                        <td align="middle"><c:out value="${item.sold}"/></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
